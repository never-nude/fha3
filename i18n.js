...
(function () {
  var ES = {
    ...
    // Site chrome (skip link, footer)
    "Skip to content": "Saltar al contenido",
    "Neighborhood Guide": "Guía del Vecindario",
    "A neighborhood association in Fisher Hill — White Plains, NY. In English y en español.": "Una asociación de vecinos en Fisher Hill — White Plains, NY. En inglés y en español.",
    "Explore": "Explorar",
    "Get involved": "Participe",
    "Become a member": "Hágase miembro",
    "Write to the board": "Escriba a la directiva",
    "The WPCNA meets monthly — typically the second Tuesday at 7:00 p.m.": "La WPCNA se reúne cada mes — generalmente el segundo martes a las 7:00 p.m.",
    // Home: board strip + guide preview
    "Fresh on the board": "Novedades en el tablón",
    "See the board →": "Ver el tablón →",
    "Neighborhood guide": "Guía del vecindario",
    "Get things done, locally.": "Resuelva lo local, aquí mismo.",
    "City services, the library, schools, the hospital, and trains — the practical links for living on the Hill.": "Servicios de la ciudad, la biblioteca, las escuelas, el hospital y los trenes — los enlaces prácticos para vivir en la colina.",
    "Open the full guide": "Abrir la guía completa",
    // Neighborhood Guide page (cards shared with the home preview)
    "City of White Plains": "Ciudad de White Plains",
    "City Hall, departments, trash & recycling, and service requests.": "El Ayuntamiento, los departamentos, la basura y el reciclaje, y las solicitudes de servicio.",
    "White Plains Public Library": "Biblioteca Pública de White Plains",
    "Cards, programs, story times, and events at the downtown library.": "Tarjetas, programas, cuentacuentos y eventos en la biblioteca del centro.",
    "White Plains Public Schools": "Escuelas Públicas de White Plains",
    "The public school district — calendars, enrollment, and school info.": "El distrito escolar público — calendarios, inscripción e información de las escuelas.",
    "Metro-North Railroad": "Ferrocarril Metro-North",
    "Trains from White Plains station to Grand Central and beyond.": "Trenes desde la estación de White Plains hacia Grand Central y más allá.",
    "White Plains Hospital": "Hospital de White Plains",
    "The hospital on the neighborhood's northeast edge — care and visitor info.": "El hospital en el borde noreste del vecindario — atención e información para visitantes.",
    "The citywide council of neighborhood associations — the FHA has a seat.": "El consejo de asociaciones de vecinos de toda la ciudad — la FHA tiene un asiento.",
    "Know your neighborhood.": "Conozca su vecindario.",
    "The practical side of living on the Hill — city services, the library, schools, the hospital, and trains, with the official links in one place.": "El lado práctico de vivir en la colina — servicios de la ciudad, la biblioteca, las escuelas, el hospital y los trenes, con los enlaces oficiales en un solo lugar.",
    "The essentials": "Lo esencial",
    "Good to know": "Conviene saber",
    "Trash, recycling & city services": "Basura, reciclaje y servicios de la ciudad",
    "— pickup schedules and service requests live on the City of White Plains website, under the Public Works department.": "— los horarios de recolección y las solicitudes de servicio están en el sitio web de la Ciudad de White Plains, en el departamento de Obras Públicas.",
    "Getting downtown": "Para ir al centro",
    "— the Metro-North station, the library, and City Center all sit just beyond the neighborhood's northeast corner, within walking distance.": "— la estación de Metro-North, la biblioteca y el City Center están justo más allá de la esquina noreste del vecindario, a poca distancia a pie.",
    "The hospital": "El hospital",
    "— White Plains Hospital and its emergency department sit just past Post Road, on the neighborhood's northeast edge.": "— el Hospital de White Plains y su sala de emergencias están justo pasando Post Road, en el borde noreste del vecindario.",
    "In an emergency, call 911.": "En una emergencia, llame al 911.",
    "For non-emergency city services, start at the City of White Plains website.": "Para servicios de la ciudad que no sean de emergencia, empiece en el sitio web de la Ciudad de White Plains.",
    "The Association is neighbors, not staff — everything here runs on participation.": "La Asociación somos vecinos, no personal — todo aquí funciona gracias a la participación.",
    "Dues are $5–$10 a year and keep the Association running.": "Las cuotas son de $5 a $10 al año y mantienen en marcha a la Asociación.",
    "Lost & found, tag sales, local businesses, neighbor offers.": "Objetos perdidos, ventas de garaje, negocios locales y ofrecimientos entre vecinos.",
    "Follow the agendas": "Siga las agendas",
    "What the board and the city are working on.": "En qué están trabajando la directiva y la ciudad.",
    "Talk to the board": "Hable con la directiva",
    "Questions, ideas, concerns — a note goes straight to the president.": "Preguntas, ideas, inquietudes — su nota llega directo al presidente.",
    "The WPCNA — the citywide council the FHA belongs to — meets monthly, typically the second Tuesday at 7:00 p.m.": "La WPCNA — el consejo de toda la ciudad al que pertenece la FHA — se reúne cada mes, generalmente el segundo martes a las 7:00 p.m.",
    // About + Contact touches
    "\"Ridgeview Avenue and Congregational Church\" — a vintage postcard from the neighborhood's first era of growth.": "\"Ridgeview Avenue and Congregational Church\" — una postal antigua de la primera época de crecimiento del vecindario.",
    "Write in English or Spanish — both are welcome. · Escriba en inglés o en español — los dos son bienvenidos.": "Escriba en inglés o en español — los dos son bienvenidos. · Write in English or Spanish — both are welcome.",
    // Feed empty states
    "No neighborhood posts right now — check back soon.": "No hay publicaciones del vecindario por ahora — vuelva pronto.",
    "Events are unavailable right now.": "Los eventos no están disponibles en este momento.",
